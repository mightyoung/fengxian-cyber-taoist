<template>
  <div class="home-container">
    ...
    <nav class="navbar">
      ...
      <div class="nav-links">
        <a href="https://github.com/666ghj/FengxianCyberTaoist" target="_blank" class="github-link">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              即使只有一段文字，<span class="highlight-bold">FengxianCyberTaoist</span> 也能基于其中的现实种子，全自动生成与之对应的至多<span class="highlight-orange">百万级Agent</span>构成的平行世界。通过上帝视角注入变量，在复杂的群体交互中寻找动态环境下的<span class="highlight-code">“局部最优解”</span>
            </p>
            <p class="slogan-text">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="../assets/logo/FengxianCyberTaoist_logo_left.jpeg" alt="FengxianCyberTaoist Logo" class="hero-logo" />
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  :disabled="loading"
                ></textarea>
                <div class="model-badge">引擎: FengxianCyberTaoist-V1.0</div>
              </div>
            </div>
