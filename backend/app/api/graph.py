...
# 获取日志器
logger = get_logger('fengxian_cyber_taoist.api')
...
def build_graph():
    ...
    try:
        ...
        # 获取配置
        graph_name = data.get('graph_name', project.name or 'FengxianCyberTaoist Graph')
        ...
        # 启动后台任务
        def build_task():
            build_logger = get_logger('fengxian_cyber_taoist.build')
            try:
